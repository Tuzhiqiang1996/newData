...
jQuery._farbtastic = function (container, callback) {
  ...
  // Insert markup
  $(container).html(
    '<div class="farbtastic"><div class="color"></div><div class="wheel"></div><div class="h-marker marker"></div><div class="sl-marker marker"></div></div>'
  ...
  if (navigator.appVersion.match(/MSIE [0-6]\./)) {
    $("*", e).each(function () {
      if (this.currentStyle.backgroundImage != "none") {
        ...
        image = this.currentStyle.backgroundImage.substring(
          5,
          image.length - 2
        );
        $(this).css({
